...
import { mockWorkers, mockWorkerMetrics } from '../mock/data';
...
const ClusterOverview = () => {
  ...
  // Fetch workers from backend (with mock fallback)
  const fetchWorkers = async () => {
    ...
    try {
      ...
      setWorkers(mockWorkers as unknown as Worker[]);
      const metrics: Record<number, WorkerMetrics> = {};
      for (const [id, m] of Object.entries(mockWorkerMetrics)) {
        metrics[Number(id)] = m as unknown as WorkerMetrics;
      }
