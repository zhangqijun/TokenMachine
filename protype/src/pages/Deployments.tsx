    ...
    <div>
      ...
      <Card
        title={
          <FuncTooltip
            title="部署列表"
            description="显示所有模型部署的详细信息。\n\n• 点击行展开查看更多\n• 支持按状态筛选\n• 支持搜索和排序"
          >
            <span>部署管理 <InfoCircleOutlined style={{ fontSize: 12, color: '#999', marginLeft: 4 }} /></span>
          </FuncTooltip>
        }
        extra={
          <FuncTooltip
            title="创建新部署"
            description="创建新的模型部署。\n\n• 选择模型和版本\n• 配置副本数量\n• 分配GPU资源\n• 选择推理引擎"
          >
            <Button
              type="primary"
              icon={<PlusOutlined />}
